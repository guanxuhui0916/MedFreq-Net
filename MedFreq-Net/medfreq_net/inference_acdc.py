...
def test(fold):
    ...
    label_path = 'DATASET_Acdc/medfreq_net_raw/medfreq_net_raw_data/Task01_ACDC/labelsTs'
    pred_path = 'medfreq_net/evaluation/medfreq_net_acdc_checkpoint/medfreq_net/3d_fullres/Task001_ACDC/medfreq_net_trainer_acdc__medfreq_net_Plansv2.1/fold_0/validation_raw/'
    ...
    file = os.path.join('.', 'inferTs', fold)
