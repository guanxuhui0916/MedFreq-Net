...
def test(fold):
    label_path= '/mnt/d/downloads/MedFreq_Net/DATASET_Synapse/medfreq_net_raw/medfreq_net_raw_data/Task02_Synapse/'
    infer_path = '/mnt/d/downloads/MedFreq-Net/medfreq_net/evaluation/medfreq_net_synapse_checkpoint/'
