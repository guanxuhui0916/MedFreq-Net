...
def test(fold):
    ...
    path = '/mnt/d/downloads/MedFreq-Net/DATASET_Tumor/medfreq_net_raw/medfreq_net_raw_data/Task003_tumor/'
    
    label_list=sorted(glob.glob(os.path.join(path,'labelsTs','*nii.gz')))

    infer_path = '/mnt/d/downloads/MedFreq-Net/medfreq_net/evaluation/medfreq_net_tumor_checkpoint/'
