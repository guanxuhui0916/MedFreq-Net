...
import torch.fft
from medfreq_net.network_architecture.acdc.module.TAA import TAA3D
...
class MFF(nn.Module):
    def __init__(self):
        ...
        self.TAA1 = TAA3D(256, 256, (2, 5, 5), axis='H')
        self.TAA2 = TAA3D(128, 128, (4, 10, 10),axis='W')
        self.TAA3 = TAA3D(64, 64, (8, 20, 20),axis='D')
    def forward(self, feat1, feat2, feat3):
        ...
        out1 = nn.functional.interpolate(out1, size=(16, 40, 40), mode='trilinear')
        out2 = self.conv1x1_2(feat2)
        out2 = nn.functional.interpolate(out2, size=(16, 40, 40), mode='trilinear')
        out3 = self.conv1x1_3(feat3)
        out3 = nn.functional.interpolate(out3, size=(16, 40, 40), mode='trilinear')
...
if __name__ == '__main__':
    feat1 = torch.randn(1, 256, 2, 5, 5)
    feat2 = torch.randn(1, 128, 4, 10, 10)
    feat3 = torch.randn(1, 64, 8, 20, 20)
