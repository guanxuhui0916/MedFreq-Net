...
from medfreq_net.network_architecture.synapse.module.MFF import MFF
...
from medfreq_net.network_architecture.synapse.model_components import MedFreqNetEncoder, UnetrUpBlock
from medfreq_net.network_architecture.synapse.module.FFE3D import FFE3D
from medfreq_net.network_architecture.synapse.module.FFE1D import FFE1D
...
class MedFreqNet(SegmentationNetwork):
    ...
    def __init__(
        ...
        Examples::
            ...
            deep supervision:
            >>> net = MedFreqNet(in_channels=1, out_channels=14, img_size=(64, 128, 128), feature_size=16, num_heads=4,
