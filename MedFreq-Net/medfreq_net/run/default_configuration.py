...
from medfreq_net.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(medfreq_net.__path__[0], "training", "network_training"),
                              base_module='medfreq_net.training.network_training'):
