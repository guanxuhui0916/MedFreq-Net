...
import argparse
from medfreq_net.preprocessing.preprocessing import resample_data_or_seg
from batchgenerators.utilities.file_and_folder_operations import maybe_mkdir_p
import medfreq_net
from medfreq_net.run.default_configuration import get_default_configuration
from multiprocessing import Pool

from medfreq_net.training.model_restore import recursive_find_python_class
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(medfreq_net.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "medfreq_net.training.network_training")

    if trainer_class is None:
        raise RuntimeError("Could not find trainer class in medfreq_net.training.network_training")
    else:
