...
from medfreq_net.network_architecture.synapse.medfreq_net_synapse import MedFreqNet
...
from medfreq_net.training.network_training.Trainer_synapse import Trainer_synapse
...
class medfreq_net_trainer_synapse(Trainer_synapse):
    """
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits[self.fold]['val'] = np.array(
                ['img0001', 'img0002', 'img0003', 'img0004', 'img0008', 'img0022', 'img0025', 'img0029', 'img0032', 'img0035', 'img0036',
                  'img0038'])
