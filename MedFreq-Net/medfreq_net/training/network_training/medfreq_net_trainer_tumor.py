...
import numpy as np
import torch
from medfreq_net.training.data_augmentation.data_augmentation_moreDA import get_moreDA_augmentation
from medfreq_net.training.loss_functions.deep_supervision import MultipleOutputLoss2
from medfreq_net.utilities.to_torch import maybe_to_torch, to_cuda
from medfreq_net.network_architecture.tumor.medfreq_net_tumor import MedFreqNet
from medfreq_net.network_architecture.initialization import InitWeights_He
from medfreq_net.network_architecture.neural_network import SegmentationNetwork
from medfreq_net.training.data_augmentation.default_data_augmentation import default_2D_augmentation_params, \
    get_patch_size, default_3D_augmentation_params
from medfreq_net.training.dataloading.dataset_loading import unpack_dataset
from medfreq_net.training.network_training.Trainer_tumor import Trainer_tumor
from medfreq_net.utilities.nd_softmax import softmax_helper
from sklearn.model_selection import KFold
from torch import nn
from torch.cuda.amp import autocast
from medfreq_net.training.learning_rate.poly_lr import poly_lr
from batchgenerators.utilities.file_and_folder_operations import *
from fvcore.nn import FlopCountAnalysis


class medfreq_net_trainer_tumor(Trainer_tumor):
    """
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        super().__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage, unpack_data,
                         deterministic, fp16)
        self.max_num_epochs = 10 # 最大训练周期
        self.initial_lr = 1e-2  # 初始学习率
        self.deep_supervision_scales = None  # 深度监督的尺度
        self.ds_loss_weights = None  # 损失权重
        self.pin_memory = True  # 锁页内存
        self.load_pretrain_weight = False  # 加载与训练权重
    ...
    def initialize_network(self):
        ...
        self.network = MedFreqNet(in_channels=self.input_channels,
